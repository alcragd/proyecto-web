...
<body>
    ...
    <main>
        <div class="container-sm my-5 p-2">
            ...
            <form autocomplete="off" id="frmLogin">
                ...
                <div class="g-recaptcha" data-sitekey="6LeeNyktAAAAAExUm6WtHBTq70bQUfh_Jv-2u9sn"></div><br>
                
                <button type="submit" class="btn btn-ipn">Entrar</button>
            </form>
            </div>
        </div>
    </main>
    ...
    <script src="docs/js/jquery-4.0.0.min.js" async defer></script>
    <script src="docs/js/validaciones.js" async defer></script>
    <script src="docs/js/login.js" async defer></script>
