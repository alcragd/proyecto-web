...
// 2. OPERACIÓN: REGISTRO ADMINISTRATIVO COMPLETO (CREATE)
    ...
    // Validar boleta duplicada (El código que te pasé en el mensaje anterior)
    ...
    // Usamos el correo y la contraseña que capturó el administrador en el input
    ...
    mysqli_stmt_bind_param($stmtUser, "ssi", $correo, $passHash, $rolAlumno); // Aquí usamos $correo en lugar de $correoAspirante
